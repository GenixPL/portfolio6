...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      RI: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      ...
      TI: (x0,x1,x2) => x0.addEventListener(x1,x2),
      TJ: x0 => x0.offsetX,
      ...
      WH: x0 => x0.first(),
      WI: (x0,x1) => x0.revokeObjectURL(x1),
      WJ: x0 => x0.sheet,
      WK: x0 => x0.height,
      X: o => [o],
      ...
      YG: x0 => x0.value,
      YH: x0 => x0.current(),
      YI: (x0,x1,x2,x3,x4) => globalThis.createImageBitmap(x0,x1,x2,x3,x4),
      YJ: x0 => x0.reload(),
      ...
      bH: () => globalThis.Intl,
      bI: x0 => x0.decode(),
      bJ: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      ...
      eJ: (x0,x1) => { x0.allowFullscreen = x1 },
      eK: x0 => x0.baseURI,
      ...
      hJ: (x0,x1) => { x0.border = x1 },
      hK: (x0,x1) => x0.getModifierState(x1),
      i: (l, r) => l === r,
      ...
      rH: (map, o) => map.get(o),
      rI: (x0,x1) => ({frameIndex: x0,completeFramesOnly: x1}),
      rJ: (x0,x1) => x0.get(x1),
      ...
      xI: () => globalThis.window.ImageDecoder,
      xJ: x0 => x0.status,
      xK: x0 => x0.body,
